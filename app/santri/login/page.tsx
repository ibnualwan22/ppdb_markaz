    ...
    <div className="min-h-screen bg-dark-950 flex flex-col items-center justify-center p-4 relative overflow-hidden">
      ...
      <div className="w-full max-w-md bg-dark-900 border border-gold-500/30 p-8 rounded-3xl shadow-[0_0_40px_rgba(212,175,55,0.05)] relative z-10">
        ...
        <div className="mt-6 text-center text-sm text-gray-400">
          <p>Lupa atau tidak tahu NIS Anda?</p>
          <a 
            href="https://wa.me/6281227225453?text=Assalamu%27alaikum%20Admin%2C%20saya%20lupa%2Ftidak%20tahu%20NIS%20saya.%20Mohon%20bantuannya%20untuk%20mengecek%20NIS%20saya." 
            target="_blank" 
            rel="noopener noreferrer"
            className="text-gold-500 hover:text-gold-400 font-medium inline-flex items-center gap-1.5 mt-1 transition-colors"
          >
