      ...
      <div className="bg-dark-950 border border-dark-800 p-6 md:p-8 rounded-2xl shadow-sm">
        ...
        {step === 2 && santriData && (
          <div className="space-y-6 animate-fadeIn">
            ...
            <button onClick={handleRenew} disabled={loading || !isAgreed || !targetDufah} className="w-full mt-8 bg-gradient-to-r from-gold-600 to-gold-400 hover:from-gold-500 hover:to-gold-300 text-black font-extrabold text-lg py-4 rounded-xl shadow-[0_0_20px_rgba(212,175,55,0.4)] transition-all active:scale-95 disabled:opacity-50">
