              ...
              <div className="fixed bottom-0 left-0 right-0 z-50 animate-slideUp">
                <div className="max-w-3xl mx-auto px-4 pb-4">
                  <div className="bg-dark-800/95 backdrop-blur-xl border border-gold-500/30 rounded-2xl shadow-[0_-5px_30px_rgba(0,0,0,0.5)] p-4 space-y-3">
                    ...
                    {/* Beli Atribut Checkbox (hanya jika bukan klaim) */}
                    {(!santriData.batasAktifDufah || !targetDufah || santriData.batasAktifDufah < targetDufah.id) && (
                    ...
                    <button 
                      onClick={handleRenew} 
                      disabled={loading || !isAgreed || !targetDufah} 
                      className="w-full bg-gradient-to-r from-gold-600 to-gold-400 hover:from-gold-500 hover:to-gold-300 text-black font-extrabold py-3 rounded-xl shadow-[0_0_20px_rgba(212,175,55,0.4)] transition-all active:scale-95 disabled:opacity-50 text-sm"
                    >
