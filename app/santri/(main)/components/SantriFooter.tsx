...
export default function SantriFooter() {
  return (
    <footer className="w-full bg-[#050505] pt-12 md:pt-20 pb-24 md:pb-10 px-4 md:px-6 border-t border-white/5 relative z-10 mt-auto">
      <div className="max-w-7xl mx-auto">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 md:gap-12 mb-12 md:mb-20">
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm text-gray-500 font-medium">
              <li><Link href="/peta" className="hover:text-gold-500 transition-colors">Lokasi Markaz</Link></li>
            </ul>
          </div>
        </div>
